...
<h1 class="home-class-heading">WAY TO HEALTHY LIFE</h1>
...
<p>Healthcare leaders are working hard to continuously refine and advance their processes in order to improve patient care, reduce costs, and improve the patient’s overall experience and satisfaction -the Triple Aim. Healthcare project management skills have become increasingly important to businesses, including the healthcare industry, because they help control costs, manage risk, and improve project outcomes</p>
<ul class="nav">
<li class="px-2">
...
<div class="col lg-6 my-auto px-5">
  <img src="ss.jpg" alt="" class="img-fluid">
 </div>
</div>
 </section>
 <section class="pricing  container-fluid my-4 pa-3 pb-3">
<div class="ll"><span class="display-1 justify-content-centre">Why Medview</span></div>
<div class="row justify-content-centre my-5 justify-content-centre dl">
    <div class="col-sm-3 justify-content-centre pl-1 mx-5 my-2">
      <div class="card cd" style="width: 20rem">
        <img src="pp.jpg" alt="" class="card-img-top ">
      <div class="card-block">
        <h4 class="card-title justify-content-centre">second opinion</h4>
        <p class="card-text">Doctor’s Reviews on the prescriptions  uploaded by the patients.</p>
    ...
    <div class="col-sm-3 justify-content-centre pl-1 mx-5 my-2">
        <div class="card cd " style="width: 20rem">
          <img src="tt.jpg" alt="" class="card-img-top">
        <div class="card-block">
          <h4 class="card-title justify-content-centre">suggestions</h4>
          <p class="card-text">Platform for  doctors to discuss a patient’s condition</p>
          <a href="#" class="btn btn-info">know more</a>
        </div>
        </div></div>
    <div class="col-sm-3  justify-content-centr pl-1 mx-5 my-2">
      <div class="card cd " style="width: 20rem">
        <img src="stethescope.jpg" alt="" class="card-img-top">
      <div class="card-block">
        <h4 class="card-title justify-content-centre">Home Remedies</h4>
        <p class="card-text">Home Remedies for all the common and uncommon diseases.</p>
        <a href="#" class="btn btn-primary">know more</a>
      </div>
      </div></div>
    </div>
...
<div class="form-group">
 <label for="uid" class="col-form-label"><b>patient id:</b></label><br>
  <input type="text" name="uid" class="form-cantrol" id="id" maxlength="2" min="1" tabindex=-1 required>
</div>
<div class="form-group">
 <label for="email" class="col-form-label"><b>patient name:</b></label><br>
  <input type="text" name="email" class="form-cantrol" id="name" autocomplete="off" required>
</div>
<div class="form-group">
...
<div class="form-group">
 <label for="id" class="col-form-label"><b>patient id:</b></label><br>
  <input type="text" name="uid" class="form-cantrol" id="id" maxlength="2" min="1" tabindex=-1 required>
</div>
<div class="form-group">
